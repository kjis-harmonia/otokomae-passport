...
const UI_CATEGORIES = [
  {
    id: '昭和の漢',
    sub: 'SHOWA MEN',
    titles: ['昭和のアイパー', 'サイドバックアイパー', 'リーゼントパンチ', 'ヤンキーパンチ', 'カールアイパー', 'バチバチパンチパーマ', 'ちょい悪オヤジ専用 昭和ヘアスタイル'],
  },
  {
    id: '王道パーマ',
    sub: 'CLASSIC PERM',
    titles: ['ニグロパーマ', '銀パラカーリー', '俺は濡れパン', 'ジャマイカンアフロ', 'スペインパーマ', 'サラリーマン専用 ギリギリパーマ'],
  },
  {
    id: '威圧感MAX',
    sub: 'MAXIMUM PRESSURE',
    titles: ['銀パラカーリー', '海軍御用達', 'シンサイ刈り', '極道ボウズ', 'トラック野郎御用達', 'テイテイ刈り', 'バチバチパンチパーマ', 'シンサイパンチ'],
  },
  {
    id: '季節限定',
    sub: 'SEASONAL',
