...
const REGISTRY: Array<{ key: string } & StyleImageDef> = [
  ...
  { key: 'シンサイパンチ',     src: '/assets/styles/shinsai-punch.png', position: '50% 30%' },
  { key: '覚醒の色',           src: '/assets/styles/kakusei.png',        position: '50% 30%' },
  { key: 'ギリギリパーマ',     src: '/assets/styles/ri-man-parm.png',   position: '50% 28%' },
  { key: '昭和ヘアスタイル',   src: '/assets/styles/showa-hair.png',    position: '50% 28%' },
