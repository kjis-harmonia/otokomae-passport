...
const SEED_DRAFTS: StyleCardDraft[] = [
  ...
  },
  {
    ...
    price: 8000,
    durationMinutes: 90,
    imageUrl: '/assets/showa-aiper.png',
  ...
  },
  {
    ...
    price: 14300,
    durationMinutes: 100,
    imageUrl: '/assets/rejent-punch.png',
  ...
  },
  {
    ...
    price: 8000,
    durationMinutes: 120,
    imageUrl: '/assets/shinsai-punch.png',
  ...
  },
  {
    ...
    price: 8000,
    durationMinutes: 75,
    imageUrl: '/assets/ri-man-parm.png',
  ...
  },
  {
    ...
    price: 8000,
    durationMinutes: 60,
    imageUrl: '/assets/showa-hair.png',
...
export function seedInitialStyles(): void {
  ...
  const STALE_PATHS: Record<string, string> = {
    ...
    // v1 → v2: /assets/styles/ prefix was incorrect (files live in /assets/)
    '/assets/styles/shinsai-punch.png':    '/assets/shinsai-punch.png',
    '/assets/styles/kakusei.png':          '/assets/kakusei.png',
    '/assets/styles/ri-man-parm.png':      '/assets/ri-man-parm.png',
    '/assets/styles/showa-hair.png':       '/assets/showa-hair.png',
  }
